...
class _UserDashBoardState extends State<UserDashBoard> {
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Center(child: Text(data[3].toString(),style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800))), flex: 1),
              Expanded(
                  child: Center(
              ...
              Expanded(
                  child: Center(
                    child: Text(requestStatus[data[4].toString()].toString(),style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800)),
                  ),
                  flex: 3),
              Expanded(
                  child: Center(
                    child: Text(prices[index].toString(),style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800)),
                  ),
                  flex: 2),
              Expanded(
                  child: Center(
                    child: ElevatedButton(
                        ...
                        child: const Text('Make Payment',style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800))),
                  ),
                  flex: 2),
            ],
          ),
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                  child: Center(
                    child: Text(data[2].toString(),style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800)),
                  ),
                  flex: 5),
              Expanded(
                  child: Center(
                  ...
                  flex: 3),
              Expanded(child: Center(child: Text(data[5].toString(),style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800))), flex: 2),
              Expanded(
                  child: Center(
                    child: ElevatedButton(
                        ...
                        child: const Text('Reject',style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800))),
                  ),
                  flex: 2),
              Expanded(
                  child: Center(
                    child: ElevatedButton(
                        ...
                        child: const Text('Accept',style:TextStyle(fontSize: 30,fontWeight: FontWeight.w800))),
                  ),
                  flex: 2),
            ],
          ),
  ...
  Widget addLand() {
    return Center(
      child: Padding(
        padding: const EdgeInsets.only(left:660,top:60),
        child: Container(
          padding: const EdgeInsets.all(10),
          ...
          width: isDesktop ? scrWidth - 2400 : scrWidth,
          height:1290,
          child: Form(
            key: _formKey,
            child: Column(
              ...
              children: <Widget>[
               ...
               SizedBox(
                width: isDesktop ? 870 : scrWidth * 0.8,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Area :', style: TextStyle(fontSize: 40,fontWeight: FontWeight.w500)),
                    Flexible(
                        child: Container(
                      width: isDesktop ? 490 : scrWidth * 0.8,
                      child: Padding(
                ...
                child: SizedBox(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Land Address:', style: TextStyle(fontSize: 40,fontWeight: FontWeight.w500)),
                        Flexible(
                          child: Container(
                            width: isDesktop ? 490 : scrWidth * 0.8,
                            child: Padding(
                ...
                child: SizedBox(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Land Price:', style: TextStyle(fontSize: 40,fontWeight: FontWeight.w500)),
                        Flexible(
                          child: Container(
                            width: isDesktop ? 490 : scrWidth * 0.8,
                            padding: const EdgeInsets.all(10),
                ...
                child: SizedBox(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Property ID:', style: TextStyle(fontSize: 40,fontWeight: FontWeight.w500)),
                        Flexible(
                          child: Container(
                            width: isDesktop ? 490 : scrWidth * 0.8,
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  border: OutlineInputBorder(),
                                  labelText: 'PID',
                                  hintText: 'Enter Property ID 11-Digits',
                                  labelStyle: TextStyle(fontSize: 30),
                                  hintStyle: TextStyle(fontSize: 30),
                                ),
                              ),
                ...
                child:SizedBox(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Survey No. :', style: TextStyle(fontSize: 40,fontWeight: FontWeight.w500)),
                      Flexible(
                          child: Container(
                        width: isDesktop ? 490 : scrWidth * 0.8,
                        child: Padding(
                ...
                // ),
                SizedBox(
                    width: isDesktop ? 900 : scrWidth * 0.8,
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Flexible(
                            child: Padding(
                              padding: isDesktop
                                  ? EdgeInsets.only(left: 10, bottom: 1, top: 50)
                                  : EdgeInsets.all(10),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  MaterialButton(
                                    ...
                                    child: Text(
                                    'Upload Document',
                                      style: TextStyle(fontSize: 30,color: Colors.white,), // Increase the font size here
                                    ),

                                  ),
                                 Padding(
                                  padding: const EdgeInsets.only(right: 110), // Adjust the padding as needed
                                  child: Text(
                                    docuName,
                                    style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600), // Increase the font size as needed
                                  ),
                                ),
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: Colors.amber),
              color: Color(0xfff5f0e1)),
          width: isDesktop ? scrWidth - 2000 : scrWidth,
          height: 1200,
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              ...
              userInfo[8]
                  ? Row(
                      children: const [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left:670), // Adjust padding as needed
                          child: Text(
                            'Verified',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            CustomTextFiled(userInfo[0].toString(), 'Wallet Address', 120), // Adjusted width
            CustomTextFiled(userInfo[1].toString(), 'Name',280), // Adjusted width
            CustomTextFiled(userInfo[2].toString(), 'Age', 315), // Adjusted width
            CustomTextFiled(userInfo[3].toString(), 'City', 320), // Adjusted width
            CustomTextFiled(userInfo[4].toString(), 'Aadhar Number', 100), // Adjusted width
            CustomTextFiled(userInfo[5].toString(), 'Pan', 315), // Adjusted width
            CustomTextFiled(userInfo[7].toString(), 'Mail', 310), // Adjusted width
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Padding(
            padding: const EdgeInsets.only(top: 70), // Add top padding
