          ...
          children: [
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Capture Photo',style: TextStyle(fontSize: 35),),
              ),
            ),
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(bottom: 80.0), // Set your desired bottom padding here
            child: Column(
              children: [
                CustomTextFiled(walletAddres.toString(), 'Wallet Address', 120),
                CustomTextFiled(name.toString(), 'Name', 280),
                CustomTextFiled(age.toString(), 'Age', 315),
                CustomTextFiled(city.toString(), 'City', 315),
                CustomTextFiled(adhar.toString(), 'Aadhar Number', 100),
                CustomTextFiled(pan.toString(), 'Pan', 315),
                CustomTextFiled(mail.toString(), 'Mail', 310),
              ],
            ),
          ),
